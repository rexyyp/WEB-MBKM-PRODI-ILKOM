...
<div class="min-h-screen pb-12">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-900 mb-2">Penilaian Konversi Mata Kuliah</h1>
        <p class="text-slate-500 text-lg">Input dan sahkan nilai akhir untuk setiap mata kuliah hasil konversi kegiatan MBKM mahasiswa.</p>
    </div>
