...
@section('content')
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900 mb-2">Penilaian MBKM</h1>
        <p class="text-slate-500 text-lg">Pantau kelengkapan nilai dari dosen dan mitra, serta sahkan konversi nilai akhir mahasiswa.</p>
    </div>
