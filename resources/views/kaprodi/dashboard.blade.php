...
@section('content')
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900 mb-1">Dashboard Kaprodi</h1>
        <p class="text-slate-500 text-lg">Pantau dan validasi kegiatan akademik MBKM mahasiswa.</p>
    </div>
