...
<div x-data="{ 
    ...
    <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-slate-500 font-medium mb-4">
            ...
            <span>/</span>
            <span class="text-slate-800 font-bold">Laporan Akhir</span>
        </div>
        <div class="flex items-center gap-3 mb-2">
            <div class="bg-blue-100 p-2.5 rounded-xl text-blue-600">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            </div>
            <h1 class="text-3xl font-bold text-blue-700 tracking-tight">Review Laporan Akhir Mahasiswa</h1>
        </div>
        <p class="text-slate-500">Validasi dokumen laporan akhir dan jadwalkan sidang.</p>
    </div>
    ...
    <div>
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-xl font-bold text-slate-900 flex items-center gap-2">
                Menunggu Review
                <span class="bg-amber-100 text-amber-700 text-xs py-0.5 px-2 rounded-full font-bold">1</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 flex flex-col justify-between">
                ...
                <button @click="openModal('Siti Aisyah', 'Implementasi UI/UX Modern Pada Dashboard')" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-sm text-sm flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    Validasi & Atur Jadwal Sidang
                </button>
            </div>
        </div>
    </div>

    {{-- Tabel Monitoring Mahasiswa Ujian (Khusus Laporan) --}}
    <div>
        <h2 class="text-xl font-bold text-slate-900 mb-5">Monitoring Jadwal Sidang Laporan</h2>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            ...
                            <th class="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider">Jadwal Sidang</th>
                    ...
                    <tbody class="divide-y divide-slate-100 text-sm">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                <div class="font-semibold text-slate-800">15 Jun 2026</div>
                                <div class="text-xs text-slate-500">14:00 WIB</div>
                            </td>
                            <td class="py-4 px-6">
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div x-show="showModal"
                ...
                <div class="bg-white px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                    <h3 class="text-xl font-bold text-slate-900" id="modal-title">Validasi & Atur Jadwal Sidang</h3>
                    ...
                    <form>
                        ...
                        <div x-show="reviewStatus === 'setuju'" x-collapse style="display: none;">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-bold text-slate-700 mb-2">Tanggal Sidang <span class="text-red-500">*</span></label>
