...
<div x-data="{ 
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500">Validasi dokumen laporan akhir dan atur jadwal ujian.</p>
    </div>
    ...
    <div>
        ...
        <div class="bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center">
            <div class="flex flex-col items-center gap-3">
                ...
                <p class="font-bold text-slate-700">Tidak ada laporan yang perlu direview</p>
                <p class="text-sm text-slate-400">Semua laporan akhir mahasiswa telah diproses.</p>
            </div>
        </div>
        @else
    ...
    {{-- Tabel Monitoring --}}
    <div>
        <h2 class="text-xl font-bold text-slate-900 mb-5">Monitoring Jadwal Ujian Laporan Akhir</h2>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex flex-col sm:flex-row items-center justify-end gap-2 w-full">
                                    ...
                                    @endif
                                    @if($ujian->status === 'disetujui')
                                    <form action="{{ route('dosen-penguji.uji-kompetensi.laporan.selesaikan', $ujian->id) }}" method="POST" class="w-full sm:w-auto"
                ...
                <div class="px-6 py-5">
                    ...
                    <template x-if="selectedFile">
                        <div class="mb-5 p-3 bg-blue-50 border border-blue-100 rounded-xl flex items-center gap-2">
                            ...
                            <a :href="selectedFile" target="_blank" class="text-sm font-bold text-blue-600 hover:underline">Lihat File Laporan</a>
                        </div>
                    </template>

                    {{-- Form dengan action dinamis --}}
                    <form :action="`/dosen-penguji/uji-kompetensi/laporan/${selectedId}/validasi`" method="POST" id="form-validasi">
                        @csrf
