...
@section('title', 'Penilaian Mahasiswa - Dosen Penguji')
...
@section('content')
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <form id="assessmentForm" class="space-y-6">
                    {{-- Nilai Dosen Penguji --}}
                    <div>
                        <label for="nilaiPenguji" class="block text-sm font-semibold text-slate-900 mb-2">Nilai Dosen Penguji</label>
                        <div class="relative">
                            <input type="number" id="nilaiPenguji" min="0" max="100" placeholder="0" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
    ...
    <script>
        ...
        document.getElementById('assessmentForm').addEventListener('submit', function(e) {
            ...
            // Validation
            if (!nilaiPenguji.value) {
                alert('Nilai Dosen Penguji harus diisi!');
                return;
            }

            if (nilaiPenguji.value < 0 || nilaiPenguji.value > 100) {
