...
@section('content')
    {{-- Header Section --}}
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-slate-900 mb-2">Pembimbing MBKM</h1>
        <p class="text-slate-600 text-lg">Informasi dosen pembimbing, dosen penguji dan pembimbing lapangan</p>
    </div>
