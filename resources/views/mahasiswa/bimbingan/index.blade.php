...
@section('content')
<div class="max-w-7xl mx-auto py-6" x-data="{ isModalOpen: false, tipeBimbingan: 'offline' }">
    {{-- Header & Summary --}}
    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-slate-900 mb-2">Riwayat Bimbingan</h1>
            <span class="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 text-slate-700 text-sm font-semibold rounded-full border border-slate-200">
                ...
                Total Bimbingan: 3 Kali <span class="text-slate-300">|</span> Syarat Minimal: 4 Kali
            </span>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    {{-- Row 1: Menunggu (Online) --}}
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="py-4 px-6 text-slate-600">08 Jun 2026</td>
                        <td class="py-4 px-6">
                            <p class="font-semibold text-slate-800">10 Jun 2026</p>
                            <p class="text-xs text-slate-500">14:00 WIB</p>
                        </td>
                        <td class="py-4 px-6 font-medium text-slate-900">Pembahasan Bab 3 & Metodologi</td>
                        <td class="py-4 px-6">
                        ...
                        <td class="py-4 px-6 text-right text-slate-400 font-medium text-lg">
                            -
                        </td>
                    </tr>
                    
                    {{-- Row 2: Terjadwal (Offline) --}}
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="py-4 px-6 text-slate-600">01 Jun 2026</td>
                        <td class="py-4 px-6">
                            <p class="font-semibold text-slate-800">03 Jun 2026</p>
                            <p class="text-xs text-slate-500">09:00 WIB</p>
                        </td>
                        <td class="py-4 px-6 font-medium text-slate-900">Revisi Bab 2 & Literatur</td>
                        <td class="py-4 px-6">
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold bg-slate-100 text-slate-600 border border-slate-200">
                    ...
                    {{-- Row 3: Terjadwal (Online) --}}
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="py-4 px-6 text-slate-600">02 Jun 2026</td>
                        <td class="py-4 px-6">
                            <p class="font-semibold text-slate-800">05 Jun 2026</p>
                            <p class="text-xs text-slate-500">10:00 WIB</p>
                        </td>
                        <td class="py-4 px-6 font-medium text-slate-900">Validasi Instrumen</td>
                        <td class="py-4 px-6">
                        ...
                        <td class="py-4 px-6 text-right">
                            <a href="#" class="inline-flex items-center gap-1.5 text-blue-600 hover:text-blue-800 font-semibold text-xs border border-blue-200 hover:bg-blue-50 px-3 py-1.5 rounded-lg transition-colors">
                    ...
                    {{-- Row 4: Selesai (Online) --}}
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="py-4 px-6 text-slate-600">20 Mei 2026</td>
                        <td class="py-4 px-6">
                            <p class="font-semibold text-slate-800">22 Mei 2026</p>
                            <p class="text-xs text-slate-500">13:00 WIB</p>
                        </td>
                        <td class="py-4 px-6 font-medium text-slate-900">Diskusi Judul dan Latar Belakang</td>
                        <td class="py-4 px-6">
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold bg-slate-100 text-slate-600 border border-slate-200">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                Online
    ...
    <div x-show="isModalOpen" 
        ...
        <div x-show="isModalOpen"
            ...
            <div class="px-6 py-6 overflow-y-auto flex-1">
                <form id="formBimbingan" action="#" method="POST" class="space-y-6">
                    {{-- Topik Bimbingan --}}
                    <div class="space-y-2">
                        <label for="topik" class="block text-sm font-semibold text-slate-700">Topik Bimbingan <span class="text-red-500">*</span></label>
                        <input type="text" id="topik" name="topik" placeholder="Contoh: Pembahasan Bab 1 & 2" class="w-full border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-3 text-slate-900" required>
                    </div>
                    ...
                    <div x-show="tipeBimbingan === 'online'" 
                        ...
                        <input type="url" id="link_meeting" name="link_meeting" placeholder="https://meet.google.com/..." class="w-full border border-blue-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5 text-slate-900" :required="tipeBimbingan === 'online'">
                    </div>
