    ...
    <div class="mb-8 animate-fade-in-up">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Uji Kompetensi: Laporan Akhir</h1>
                    <p class="text-slate-500 mt-1 font-medium mb-3">Ajukan dokumen laporan akhir Anda untuk direview oleh Dosen Penguji.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border overflow-hidden w-full mb-8
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="flex items-center justify-between p-5 rounded-2xl border
                {{ $sudahUploadLaporan ? 'bg-white border-green-200 hover:border-green-300' : 'bg-white border-red-200 hover:border-red-300' }} transition-colors">
                <div class="flex items-center gap-4">
                    @if($sudahUploadLaporan)
                        ...
                        <div>
                            <p class="font-bold text-base text-slate-800 mb-0.5">Laporan MBKM</p>
                            <p class="text-sm font-medium text-slate-500">Diupload: <span class="text-green-600 font-bold">{{ $dokumenLaporan->uploaded_at ? \Carbon\Carbon::parse($dokumenLaporan->uploaded_at)->translatedFormat('d M Y') : '-' }}</span></p>
                        </div>
                    @else
        ...
        <div class="p-8 bg-slate-50/50">
            @if(!$bolehAjukan && $status === 'draft')
                ...
                <div class="flex flex-col items-center text-center py-8 max-w-md mx-auto">
                    ...
                    <p class="text-sm font-medium text-slate-500 leading-relaxed">Lengkapi semua prasyarat di atas terlebih dahulu sebelum Anda dapat mengajukan uji kompetensi laporan akhir.</p>
                </div>
            @else
                    ...
                    <tr>
                        <td colspan="4" class="py-12 px-6 text-center">
                            <div class="flex flex-col items-center justify-center gap-3 text-slate-400">
                                ...
                                <p class="text-sm font-medium">Anda belum pernah mengajukan uji kompetensi laporan akhir.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
