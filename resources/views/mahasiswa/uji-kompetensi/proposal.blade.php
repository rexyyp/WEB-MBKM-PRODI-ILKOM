...
<div x-data="{ 
    ...
    <h2 class="text-lg font-bold mt-10 mb-4 text-slate-900">Catatan Revisi Proposal Penguji</h2>
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden w-full">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-right">
                            <button @click="openCatatan('26 Mar 2026', 'Bagian latar belakang perlu diperjelas kaitannya dengan proyek MBKM di tempat magang. Tolong sertakan data pendukung yang lebih valid sebelum diajukan kembali.')" class="inline-flex items-center gap-1.5 text-blue-600 hover:text-blue-800 font-bold text-xs transition-colors">
