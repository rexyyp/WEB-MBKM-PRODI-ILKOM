...
@section('title', 'Penilaian Mahasiswa Bimbingan')
...
<div x-data="{ 
    ...
    @endif
    @if($errors->any())
    <div class="bg-red-50 border border-red-200 rounded-xl px-5 py-4 flex flex-col gap-1">
        <div class="flex items-center gap-3">
            ...
            <p class="text-red-800 font-semibold text-sm">Gagal menyimpan penilaian</p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-blue-700 tracking-tight">Penilaian Mahasiswa Bimbingan</h1>
                </div>
                <p class="text-slate-500">Beri nilai akademik untuk mahasiswa bimbingan MBKM Anda.</p>
            </div>
            
            {{-- Search Box (Optional) --}}
            <form action="{{ route('dosen-pembimbing.penilaian.index') }}" method="GET" class="relative">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    @php
                        ...
                        // Cari nilai dari dosen pembimbing
                        $nilaiObj = $pendaftaran->penilaians->where('jenis_penilai', 'pembimbing')->first();
                    ...
                    <tr>
                        <td colspan="4" class="py-12 text-center text-slate-400">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <p class="font-medium">Belum ada mahasiswa bimbingan yang harus dinilai.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    <div x-show="showModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div x-show="showModal"
                ...
                {{-- Form Content --}}
                <form action="{{ route('dosen-pembimbing.penilaian.simpan') }}" method="POST">
                    @csrf
                    <input type="hidden" name="pendaftaran_id" :value="selectedId">
                    <div class="px-6 py-6">
                        <label class="block text-sm font-bold text-slate-700 mb-2">Nilai Pembimbing (0 - 100) <span class="text-rose-500">*</span></label>
                        <p class="text-xs text-slate-500 mb-4 leading-relaxed">Nilai ini akan diakumulasikan dengan nilai dari Penguji dan Mitra oleh Koordinator Program Studi untuk menjadi Nilai Akhir mahasiswa.</p>
                        
                        <div class="relative max-w-xs">
                            <input type="number" name="nilai_total" x-model="nilai" min="0" max="100" step="0.01" required
