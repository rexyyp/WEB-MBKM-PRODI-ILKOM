<aside class="w-64 bg-white border-r border-slate-200 h-screen sticky top-0 flex flex-col shadow-sm">
    {{-- Header --}}
    ...
    {{-- Nav Menu --}}
    <div class="px-4 py-5 flex-1 overflow-y-auto min-h-0">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('admin.kaprodi.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-colors text-sm
                      {{ request()->routeIs('admin.kaprodi.*') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-indigo-600' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.tenggat-dokumen.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-colors text-sm
                      {{ request()->routeIs('admin.tenggat-dokumen.*') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50 hover:text-indigo-600' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-4 py-4 border-t border-slate-200 space-y-3">
        {{-- User Info Card --}}
        <div class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-slate-50">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-slate-700 truncate">{{ auth()->user()->name ?? 'Admin' }}</p>
                <p class="text-[10px] text-slate-400 uppercase tracking-wider font-medium">Administrator</p>
            </div>
        </div>
        ...
        <a href="{{ route('auth.logout') }}"
           id="btn-logout-admin"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all text-sm w-full
